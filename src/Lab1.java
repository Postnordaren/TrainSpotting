...
public class Lab1 {
  ...
  // Semaphores for our station
  public static Semaphore northStation1Semaphore = new Semaphore(1);
  public static Semaphore northStation2Semaphore = new Semaphore(1); 
  public static Semaphore southStation1Semaphore = new Semaphore(1); 
  public static Semaphore southStation2Semaphore = new Semaphore(1);

  // Semaphores for other critical points
  public static Semaphore track1 = new Semaphore(1);
  public static Semaphore track2 = new Semaphore(1);
  public static Semaphore track3 = new Semaphore(1);
  public static Semaphore track4 = new Semaphore(1);
   ...
   public void northStationSensor(SensorEvent sensor) {
    //if (sensor.getStatus() == SensorEvent.ACTIVE) { // Bara när tåget kommer in
        try {
            ...
            Lab1.northStation1Semaphore.acquire();
            ...
            Lab1.northStation1Semaphore.release();
        }
  }
  ...
  public void southStationSensor(SensorEvent sensor) {
    //if (sensor.getStatus() == SensorEvent.ACTIVE) { // Bara när tåget kommer in
        try {
            System.out.println(sensor.getXpos() + " " + sensor.getYpos() + " ...");
            Lab1.southStation1Semaphore.acquire();
            tsi.setSpeed(trainId, 0);
            Thread.sleep(sleepTime);
            switchDirection();
        } catch (Exception e) {
            ...
            Lab1.southStation1Semaphore.release();
        }
      }
    }
